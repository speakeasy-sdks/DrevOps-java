...
public class GetPipelineByNumberPipeline {
    ...
    public GetPipelineByNumberPipeline withState(GetPipelineByNumberPipelineState state) {
        this.state = state;
        return this;
    }
