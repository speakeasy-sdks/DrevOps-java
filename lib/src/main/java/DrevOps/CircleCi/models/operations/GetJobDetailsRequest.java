...
public class GetJobDetailsRequest {
    ...
    public GetJobDetailsRequest withJobNumber(Object jobNumber) {
    ...
    public GetJobDetailsRequest withProjectSlug(String projectSlug) {
        this.projectSlug = projectSlug;
        return this;
    }
    
    public GetJobDetailsRequest(@JsonProperty("job-number") Object jobNumber, @JsonProperty("project-slug") String projectSlug) {
        this.jobNumber = jobNumber;
        this.projectSlug = projectSlug;
  }
}
