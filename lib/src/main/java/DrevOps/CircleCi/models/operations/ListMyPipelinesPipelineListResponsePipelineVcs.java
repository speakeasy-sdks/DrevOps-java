 ...
 */
public class ListMyPipelinesPipelineListResponsePipelineVcs {
    /**
    ...
    public ListMyPipelinesPipelineListResponsePipelineVcs(@JsonProperty("origin_repository_url") String originRepositoryUrl, @JsonProperty("provider_name") String providerName, @JsonProperty("revision") String revision, @JsonProperty("target_repository_url") String targetRepositoryUrl) {
        this.originRepositoryUrl = originRepositoryUrl;
        this.providerName = providerName;
        this.revision = revision;
        this.targetRepositoryUrl = targetRepositoryUrl;
