 ...
 */
public enum ListCheckoutKeysCheckoutKeyListResponseCheckoutKeyCheckoutKeyTypeEnum {
    ...
    private ListCheckoutKeysCheckoutKeyListResponseCheckoutKeyCheckoutKeyTypeEnum(String value) {
        this.value = value;
    }
}
