...
public class ListContexts200ApplicationJSONContext {
    /**
    ...
    public ListContexts200ApplicationJSONContext(@JsonProperty("created_at") OffsetDateTime createdAt, @JsonProperty("id") String id, @JsonProperty("name") String name) {
        this.createdAt = createdAt;
        this.id = id;
        this.name = name;
  }
